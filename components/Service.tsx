        ...
        <section id="services" className="ptb">
            ...
            <div className="wrapper-service container flex-row">
                <article className="align-center">
                    ...
                    <p>Enregistrez et consultez les fiches administratives, médicales et les comptes-rendus. Conservez les prescriptions de soins. </p>
                </article>
                <article className="align-center">
                ...
                <article className="align-center">
                    ...
                    <p>Gardez un œil sur l'évolution de l'état de vos patients. Préservez un historique de votre prise en charge.
                    </p>
                </article>
                <article className="align-center">
                ...
                <article className="align-center">
                    ...
                    <p>Automatisez la création, la consultation et l'impression de vos factures. Suivez vos paiements et vos revenues en temps réel.
                    </p>
                </article>
                <article className="align-center">
