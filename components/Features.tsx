        ...
        <section id="avantage" className="ptb">
            <div className="wrapper-feature container flex-row">
                ...
                <div className="single-feature">
                    <img src="/image/espace.png" alt="Digitalisation de votre travail" />
                ...
                <div className="single-feature">
                    <img src="/image/temps.png" alt="Organisation optimisée" />
                ...
                <div className="single-feature">
                    <img src="/image/gestionDonnees.png" alt="Amélioration de la gestion des données" />
                ...
                <div className="single-feature">
                    <img src="/image/dossiersPatients.png" alt="Dossiers patients centralisés" />
                ...
                <div className="single-feature">
                    <img src="/image/suivi.png" alt="Facturation automatisée" />
                ...
                <div className="single-feature">
                    <img src="/image/analyses.png" alt="Rapports et analyses" />
