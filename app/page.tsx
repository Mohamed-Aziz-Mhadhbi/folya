                            ...
                            <div className="container wrapper-booking flex-row">
                                <div className="booking-form">
                                    <form id="bookingForm" method="POST">
                                        ...
                                        <div className="wrapper-input flex-row">
                                            <input type="text" id="city" name="city" placeholder="Ville d'exercice" />
                                            <input type="text" id="specialty" name="specialty" placeholder="Votre spécialité paramédicale" />
                                        </div>
                                        <div className="wrapper-input flex-row">
                                            <input type="text" id="message" name="message" placeholder="Message" className="large-input" />
                                        </div>
                                        <button className="btn" id="sendbook" type="submit">Obtenez un devis gratuitement</button>
                                ...
                                <div className="booking-working-hours">
                                    ...
                                    <p>Afin de mieux répondre à vos besoins, veuillez remplir le formulaire ci-dessous. Plus vous nous fournirez d'informations, plus nous serons en mesure de vous proposer un devis précis et adapté à vos besoins</p>
                                </div>
                            </div>
