...
class VideoHandler {
    static get OBSERVER_ATTRIBUTE_FILTER() {
        return ['class', 'hidden'];
    }
    ...
    static get SELECTOR_PLAYER() {
        return null;
    }
    static get SELECTOR_PLAYER_SKIP_AD() {
        return null;
    }
    static get SELECTOR_PLAYER_FFORWARD() {
        return null;
    }
    static get SELECTOR_PLAYER_SEEK_BAR() {
        return null;
    }
    static get SELECTOR_PLAYER_LIVE() {
        return null;
    }
    static get SELECTOR_PLAYER_VOLUME() {
        return null;
    }
